...
The creation scan seeds both pages. Later scans and clears update only their own
page and group; source and generated assignments are saved independently.
