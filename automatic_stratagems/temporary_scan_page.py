...
class TemporaryScanPages:
    ...
    def metadata(self, path):
        ...
        if (not isinstance(meta, dict) or meta.get('owner') != PLUGIN_ID or meta.get('version') != 1
    ...
    def create(self, controller, source_page, group, backend):
        ...
        data = {MARKER: dict(owner=PLUGIN_ID, version=1, source_page=str(Path(source_page).absolute()),
