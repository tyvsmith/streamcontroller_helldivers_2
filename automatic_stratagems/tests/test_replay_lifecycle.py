...
from . import test_scan_actions as action_tests
...
class ReplayLifecycleTests(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        action_tests.ActionTests.setUpClass()

    def setUp(self):
        temporary = TemporaryDirectory()
        self.addCleanup(temporary.cleanup)
        self.root = Path(temporary.name)
        self.harness = action_tests.ActionTests()
        self.harness.setUp()
        self.mod = self.harness.mod
        ...
        self.harness.deck = self.deck
        self.harness.page = self.deck.active_page
        self.coordinator = self.mod.ScanCoordinator(self.plugin, self.root / 'scan-state')
        self.harness.coordinator = self.coordinator
        ...
        self.opener = self.harness.rendering_action(self.mod.AutoStratagems)
